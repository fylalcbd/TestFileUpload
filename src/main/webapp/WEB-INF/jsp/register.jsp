...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="/statics/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="/statics/css/passport.base.css"/>
...
<script type="text/javascript">
	var REGISTER={
		...
		doSubmit:function() {
			$.post("/register/register",$("#personRegForm").serialize(), function(data){
				if(data.status == 200){
					alert('用户注册成功，请登录！');
					REGISTER.login();
				} else {
